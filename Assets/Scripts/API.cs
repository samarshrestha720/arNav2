...
public class API : MonoBehaviour
{
    ...
    const string BundleFolder = "https://flasktest1.samarshrestha72.repl.co/AssetBundles/";
    ...
    IEnumerator GetDisplayBundleRoutine(string assetName, UnityAction<GameObject> callback, Transform bundleParent)
    {
        ...
        if (www.isNetworkError) //if(www.result == UnityWebRequest.Result.ConnectionError)
        {
